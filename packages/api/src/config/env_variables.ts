export const ENV = {
  ...
  // TODO: Change this to TODOS_RESOLUTIONS_TABLE
  TODO_RESOLUTIONS_TABLE: process.env.TODOS_RESOLUTIONS_TABLE || 'RESOLUTIONS',
  TODO_CURRENT_TABLE: process.env.TODOS_CURRENT_TABLE || 'TODO_CURRENT',
