import TodosHistoryProjectMenu from '../../../features/todos/components/history/TodosHistoryProjectMenu.tsx';
import TodosHistoryTable from '../../../features/todos/components/history/TodosHistoryTable.tsx';
import useQueryProjectNames from '../../../features/todos/hooks/useQueryProjectNames.ts';
import useQueryProjectTodos from '../../../features/todos/hooks/useQueryProjectTodos.ts';
import {
  CalendarDaysIcon,
...
export const Route = createFileRoute('/_authenticated/todos/history')({
  component: TodosHistory,
});
